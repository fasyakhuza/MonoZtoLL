...
void xAna_ztoee_genlevelonly_test(string inputfile = "ExoPieElementTuples_MonoZLL_NLO_Mphi-500_Mchi2-150_Mchi1-1_gSM-0p25_gDM-1p0_ctau1p0.root", string outputfile = "Kinematics_Mchi2-150_Mchi1-1_ctau1p0_test.root")
{
    //get TTree from file ...
    ...
    TH1F* h_phi_Z = new TH1F("h_phi_Z", "Phi of Z bosons", 50, -3, 3);
