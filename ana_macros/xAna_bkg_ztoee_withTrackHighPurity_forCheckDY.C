...
void xAna_bkg_ztoee_withTrackHighPurity_forCheckDY(string inputtxtFilename, string outputfile)
{
        ...
        //for (Long64_t jEntry = 0; jEntry < 10000; jEntry++)
        {
            ...
            if (matchee)
            {
                ...
                if (recoeeEvent)
                {
                    ...
                    {
                        cout << "Event-" << jEntry << " has " << goodElectrons.size() << " electron." << endl;
                    }
                    ...
                    //    {
                    //        iPassAK4 = indexForPassAK4[i];
                    //        TLorentzVector* newThisTHINjet = new TLorentzVector(THINjetPx[iPassAK4], THINjetPy[iPassAK4], THINjetPz[iPassAK4], THINjetEnergy[iPassAK4]);
                    //        v_passJetPt.push_back(newThisTHINjet->Pt());
                    //        v_passJetEta.push_back(newThisTHINjet->Eta());
                    //    }
                    //}
                    ...
                    vector<int>* THINjetTrackStatus = data.GetPtrVectorInt("THINjetTrackStatus", nTHINjets);
                    ...
                    for (int i = 0; i < indexForPassAK4.size(); i++)
                    {
                        ...
                        for (int j = 0; j < THINjetNTracks[correctjet_index]; j++)
                        {
                            ...
                            int trackStatus = THINjetTrackStatus[correctjet_index][j];
                            int trackHighPurity = THINjetTrackHighPurity[correctjet_index][j];
                            //----------------------
                            // Calculate DeltaR
                            //----------------------
                            ...
                            if (isinf(dzError) == 1 || isinf(dxyError) == 1)
                            {
                                cout << "warning dzerr or dxyerr is infinite" << "\n";
                                //continue;
                            }
                            if (dzError == 0 || dxyError == 0)
                            {
                                cout << "warning dzerr or dxyerr is zero" << "\n";
                                //continue;
                            }
                            ...
                            v_TrackStatus.push_back(trackStatus);
                            v_TrackHighPurity.push_back(trackHighPurity);
