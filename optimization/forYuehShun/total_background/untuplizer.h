...
class TreeReader {
 ...
 public:
   ...
   //TreeReader(const char* path, const char* treename = "outTree");
   //TreeReader(const char** paths, int npaths, const char* treename = "outTree");
   //TreeReader(std::vector<std::string> paths, const char* treename = "outTree");
