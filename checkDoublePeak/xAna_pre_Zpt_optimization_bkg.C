...
//void xAna_bkg_ztoee_forCheckSkimmedTree(string inputFilename = "../DYJetsToLL_M-50_HT-70to100_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8.root", string outputfile = "outputEffCheck_DYJetsToLL_M-50_HT-70to100_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8.root")
{
    ...
    TH1D* h_MET_beforeDileptonPtCut = new TH1D("h_MET_beforeDileptonPtCut", "MET before Dilepton Pt cuts", 1000, 0, 1000);
    h_MET_beforeDileptonPtCut->Sumw2();
    ...
    h_MET_beforeDileptonPtCut->Reset();
        ...
        for (Long64_t jEntry = 0; jEntry < data.GetEntriesFast(); jEntry++)
        {
            ...
            //if (matchee)
            {
                ...
                if (recoeeEvent)
                {
                    ...
                    h_MET_beforeDileptonPtCut->Fill(met, eventWeight);
    ...
    h_MET_beforeDileptonPtCut->Write();
