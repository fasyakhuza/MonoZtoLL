...
void xAna_pre_MET_optimization_DYincl(string inputtxtFilename, string outputtxtFilename)
...
//void xAna_bkg_ztoee_forCheckSkimmedTree(string inputFilename = "../DYJetsToLL_M-50_HT-70to100_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8.root", string outputfile = "outputEffCheck_DYJetsToLL_M-50_HT-70to100_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8.root")
{
    ...
    //h_deltaR_ak4ele_afterjetcleaning for all categories
    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT0to70 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT0to70", "DeltaR between goodThinJet and goodEle for HT0to70", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT0to70->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT70to100 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT70to100", "DeltaR between goodThinJet and goodEle for HT70to100", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT70to100->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT100to200 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT100to200", "DeltaR between goodThinJet and goodEle for HT100to200", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT100to200->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT200to400 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT200to400", "DeltaR between goodThinJet and goodEle for HT200to400", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT200to400->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT400to600 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT400to600", "DeltaR between goodThinJet and goodEle for HT400to600", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT400to600->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT600to800 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT600to800", "DeltaR between goodThinJet and goodEle for HT600to800", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT600to800->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT800to1200 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT800to1200", "DeltaR between goodThinJet and goodEle for HT800to1200", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT800to1200->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT1200to2500 = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT1200to2500", "DeltaR between goodThinJet and goodEle for HT1200to2500", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT1200to2500->Sumw2();

    TH1D *h_deltaR_ak4ele_afterjetcleaning_DYincl_HT2500toInf = new TH1D("h_deltaR_ak4ele_afterjetcleaning_DYincl_HT2500toInf", "DeltaR between goodThinJet and goodEle for HT2500toInf", 1000, 0, 1000);
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT2500toInf->Sumw2();


    //h_DilepPt_afterNthinjets for all categories
    TH1D* h_DilepPt_afterNthinjets_DYincl_HT0to70 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT0to70", "Dilepton pT after nThinJets for HT0to70", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT0to70->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT70to100 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT70to100", "Dilepton pT after nThinJets for HT70to100", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT70to100->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT100to200 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT100to200", "Dilepton pT after nThinJets for HT100to200", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT100to200->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT200to400 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT200to400", "Dilepton pT after nThinJets for HT200to400", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT200to400->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT400to600 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT400to600", "Dilepton pT after nThinJets for HT400to600", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT400to600->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT600to800 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT600to800", "Dilepton pT after nThinJets for HT600to800", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT600to800->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT800to1200 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT800to1200", "Dilepton pT after nThinJets for HT800to1200", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT800to1200->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT1200to2500 = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT1200to2500", "Dilepton pT after nThinJets for HT1200to2500", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT1200to2500->Sumw2();

    TH1D* h_DilepPt_afterNthinjets_DYincl_HT2500toInf = new TH1D("h_DilepPt_afterNthinjets_DYincl_HT2500toInf", "Dilepton pT after nThinJets for HT2500toInf", 1000, 0, 1000);
    h_DilepPt_afterNthinjets_DYincl_HT2500toInf->Sumw2();


    //h_deltaR_eleele_afterNthinjets for all categories
    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT0to70 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT0to70", "DeltaR after nThinJets for HT0to70", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT0to70->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT70to100 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT70to100", "DeltaR after nThinJets for HT70to100", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT70to100->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT100to200 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT100to200", "DeltaR after nThinJets for HT100to200", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT100to200->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT200to400 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT200to400", "DeltaR after nThinJets for HT200to400", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT200to400->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT400to600 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT400to600", "DeltaR after nThinJets for HT400to600", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT400to600->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT600to800 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT600to800", "DeltaR after nThinJets for HT600to800", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT600to800->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT800to1200 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT800to1200", "DeltaR after nThinJets for HT800to1200", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT800to1200->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT1200to2500 = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT1200to2500", "DeltaR after nThinJets for HT1200to2500", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT1200to2500->Sumw2();

    TH1D* h_deltaR_eleele_afterNthinjets_DYincl_HT2500toInf = new TH1D("h_deltaR_eleele_afterNthinjets_DYincl_HT2500toInf", "DeltaR after nThinJets for HT2500toInf", 100, 0.0, 1.0);
    h_deltaR_eleele_afterNthinjets_DYincl_HT2500toInf->Sumw2();


    //h_DilepPt_afterDilepPt for all categories
    TH1D* h_DilepPt_afterDilepPt_DYincl_HT0to70 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT0to70", "Dilepton pT after dilepton pT cut for HT0to70", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT0to70->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT70to100 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT70to100", "Dilepton pT after dilepton pT cut for HT70to100", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT70to100->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT100to200 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT100to200", "Dilepton pT after dilepton pT cut for HT100to200", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT100to200->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT200to400 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT200to400", "Dilepton pT after dilepton pT cut for HT200to400", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT200to400->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT400to600 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT400to600", "Dilepton pT after dilepton pT cut for HT400to600", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT400to600->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT600to800 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT600to800", "Dilepton pT after dilepton pT cut for HT600to800", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT600to800->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT800to1200 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT800to1200", "Dilepton pT after dilepton pT cut for HT800to1200", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT800to1200->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT1200to2500 = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT1200to2500", "Dilepton pT after dilepton pT cut for HT1200to2500", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT1200to2500->Sumw2();

    TH1D* h_DilepPt_afterDilepPt_DYincl_HT2500toInf = new TH1D("h_DilepPt_afterDilepPt_DYincl_HT2500toInf", "Dilepton pT after dilepton pT cut for HT2500toInf", 1000, 0, 1000);
    h_DilepPt_afterDilepPt_DYincl_HT2500toInf->Sumw2();


    //h_DilepPt_afterMET for all HT categories
    TH1D* h_DilepPt_afterMET_DYincl_HT0to70 = new TH1D("h_DilepPt_afterMET_DYincl_HT0to70", "Dilepton pT after MET cut for HT0to70", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT0to70->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT70to100 = new TH1D("h_DilepPt_afterMET_DYincl_HT70to100", "Dilepton pT after MET cut for HT70to100", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT70to100->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT100to200 = new TH1D("h_DilepPt_afterMET_DYincl_HT100to200", "Dilepton pT after MET cut for HT100to200", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT100to200->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT200to400 = new TH1D("h_DilepPt_afterMET_DYincl_HT200to400", "Dilepton pT after MET cut for HT200to400", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT200to400->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT400to600 = new TH1D("h_DilepPt_afterMET_DYincl_HT400to600", "Dilepton pT after MET cut for HT400to600", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT400to600->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT600to800 = new TH1D("h_DilepPt_afterMET_DYincl_HT600to800", "Dilepton pT after MET cut for HT600to800", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT600to800->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT800to1200 = new TH1D("h_DilepPt_afterMET_DYincl_HT800to1200", "Dilepton pT after MET cut for HT800to1200", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT800to1200->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT1200to2500 = new TH1D("h_DilepPt_afterMET_DYincl_HT1200to2500", "Dilepton pT after MET cut for HT1200to2500", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT1200to2500->Sumw2();

    TH1D* h_DilepPt_afterMET_DYincl_HT2500toInf = new TH1D("h_DilepPt_afterMET_DYincl_HT2500toInf", "Dilepton pT after MET cut for HT2500toInf", 1000, 0, 1000);
    h_DilepPt_afterMET_DYincl_HT2500toInf->Sumw2();


    //h_after_MET_scan_bkg for all HT categories
    TH1D* h_after_MET_scan_bkg_DYincl_HT0to70 = new TH1D("h_after_MET_scan_bkg_DYincl_HT0to70", "Dilepton pT after met scanning for HT0to70", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT0to70->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT70to100 = new TH1D("h_after_MET_scan_bkg_DYincl_HT70to100", "Dilepton pT after met scanning for HT70to100", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT70to100->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT100to200 = new TH1D("h_after_MET_scan_bkg_DYincl_HT100to200", "Dilepton pT after met scanning for HT100to200", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT100to200->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT200to400 = new TH1D("h_after_MET_scan_bkg_DYincl_HT200to400", "Dilepton pT after met scanning for HT200to400", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT200to400->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT400to600 = new TH1D("h_after_MET_scan_bkg_DYincl_HT400to600", "Dilepton pT after met scanning for HT400to600", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT400to600->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT600to800 = new TH1D("h_after_MET_scan_bkg_DYincl_HT600to800", "Dilepton pT after met scanning for HT600to800", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT600to800->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT800to1200 = new TH1D("h_after_MET_scan_bkg_DYincl_HT800to1200", "Dilepton pT after met scanning for HT800to1200", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT800to1200->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT1200to2500 = new TH1D("h_after_MET_scan_bkg_DYincl_HT1200to2500", "Dilepton pT after met scanning for HT1200to2500", 1000, 0, 1000);
    h_after_MET_scan_bkg_DYincl_HT1200to2500->Sumw2();

    TH1D* h_after_MET_scan_bkg_DYincl_HT2500toInf = new TH1D("h_after_MET_scan_bkg_DYincl_HT2500toInf", "Dilepton pT after met scanning for HT2500toInf", 1000, 0, 1000);
    ...
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT0to70->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT70to100->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT100to200->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT200to400->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT400to600->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT600to800->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT800to1200->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT1200to2500->Reset();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT2500toInf->Reset();
    ...
    h_deltaR_eleele_afterNthinjets_DYincl_HT0to70->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT70to100->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT100to200->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT200to400->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT400to600->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT600to800->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT800to1200->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT1200to2500->Reset();
    h_deltaR_eleele_afterNthinjets_DYincl_HT2500toInf->Reset();
    ...
    h_DilepPt_afterMET_DYincl_HT0to70->Reset();
    h_DilepPt_afterMET_DYincl_HT70to100->Reset();
    h_DilepPt_afterMET_DYincl_HT100to200->Reset();
    h_DilepPt_afterMET_DYincl_HT200to400->Reset();
    h_DilepPt_afterMET_DYincl_HT400to600->Reset();
    h_DilepPt_afterMET_DYincl_HT600to800->Reset();
    h_DilepPt_afterMET_DYincl_HT800to1200->Reset();
    h_DilepPt_afterMET_DYincl_HT1200to2500->Reset();
    h_DilepPt_afterMET_DYincl_HT2500toInf->Reset();
            ...
            //if (matchee)
            {
                ...
                if (recoeeEvent)
                {
                    ...
                    for (int itj = 0; itj < nTHINjets; itj++)
                    {
                        ...
                        for (int j = 0; j < static_cast<int>(goodElectrons.size()); j++)
                        {
                            if (HT < 70)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT0to70->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 70 && HT < 100)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT70to100->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 100 && HT < 200)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT100to200->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 200 && HT < 400)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT200to400->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 400 && HT < 600)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT400to600->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 600 && HT < 800)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT600to800->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 800 && HT < 1200)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT800to1200->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 1200 && HT < 2500)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT1200to2500->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                            else if (HT >= 2500)
                            {
                                h_deltaR_ak4ele_afterjetcleaning_DYincl_HT2500toInf->Fill(thisTHINjet->DeltaR(goodElectrons[j]), eventWeight);
                            }
                        }
                    ...
                    if (HT < 70)
                    {
                        ...
                        h_deltaR_eleele_afterNthinjets_DYincl_HT0to70->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 70 && HT < 100)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT70to100->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT70to100->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 100 && HT < 200)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT100to200->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT100to200->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 200 && HT < 400)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT200to400->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT200to400->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 400 && HT < 600)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT400to600->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT400to600->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 600 && HT < 800)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT600to800->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT600to800->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 800 && HT < 1200)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT800to1200->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT800to1200->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 1200 && HT < 2500)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT1200to2500->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT1200to2500->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    else if (HT >= 2500)
                    {
                        h_DilepPt_afterNthinjets_DYincl_HT2500toInf->Fill(Zboson.Pt(), eventWeight);
                        h_deltaR_eleele_afterNthinjets_DYincl_HT2500toInf->Fill(goodElectrons[0].DeltaR(goodElectrons[1]), eventWeight);
                    }
                    ...
                    h_ee_npass->Fill(9, eventWeight);
                    h_ee_npass_noweight->Fill(9);
                    if (HT < 70)
                    {
                        h_DilepPt_afterMET_DYincl_HT0to70->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 70 && HT < 100)
                    {
                        h_DilepPt_afterMET_DYincl_HT70to100->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 100 && HT < 200)
                    {
                        h_DilepPt_afterMET_DYincl_HT100to200->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 200 && HT < 400)
                    {
                        h_DilepPt_afterMET_DYincl_HT200to400->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 400 && HT < 600)
                    {
                        h_DilepPt_afterMET_DYincl_HT400to600->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 600 && HT < 800)
                    {
                        h_DilepPt_afterMET_DYincl_HT600to800->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 800 && HT < 1200)
                    {
                        h_DilepPt_afterMET_DYincl_HT800to1200->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 1200 && HT < 2500)
                    {
                        h_DilepPt_afterMET_DYincl_HT1200to2500->Fill(Zboson.Pt(), eventWeight);
                    }
                    else if (HT >= 2500)
                    {
                        h_DilepPt_afterMET_DYincl_HT2500toInf->Fill(Zboson.Pt(), eventWeight);
                    }
    ...
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT0to70->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT70to100->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT100to200->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT200to400->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT400to600->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT600to800->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT800to1200->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT1200to2500->Write();
    h_deltaR_ak4ele_afterjetcleaning_DYincl_HT2500toInf->Write();
    ...
    h_deltaR_eleele_afterNthinjets_DYincl_HT0to70->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT70to100->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT100to200->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT200to400->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT400to600->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT600to800->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT800to1200->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT1200to2500->Write();
    h_deltaR_eleele_afterNthinjets_DYincl_HT2500toInf->Write();
    ...
    h_DilepPt_afterMET_DYincl_HT0to70->Write();
    h_DilepPt_afterMET_DYincl_HT70to100->Write();
    h_DilepPt_afterMET_DYincl_HT100to200->Write();
    h_DilepPt_afterMET_DYincl_HT200to400->Write();
    h_DilepPt_afterMET_DYincl_HT400to600->Write();
    h_DilepPt_afterMET_DYincl_HT600to800->Write();
    h_DilepPt_afterMET_DYincl_HT800to1200->Write();
    h_DilepPt_afterMET_DYincl_HT1200to2500->Write();
    h_DilepPt_afterMET_DYincl_HT2500toInf->Write();
