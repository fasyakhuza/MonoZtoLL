...
void xAna_pre_MET_optimization_bkg(string inputtxtFilename, string outputtxtFilename)
...
//void xAna_bkg_ztoee_forCheckSkimmedTree(string inputFilename = "../DYJetsToLL_M-50_HT-70to100_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8.root", string outputfile = "outputEffCheck_DYJetsToLL_M-50_HT-70to100_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8.root")
{
    ...
    TH1D* h_DilepMass_afterRecoee = new TH1D("h_DilepMass_afterRecoee", "Dilepton mass after recoee", 1000, 0, 1000);
    h_DilepMass_afterRecoee->Sumw2();

    TH1D* h_DilepEta_afterRecoee = new TH1D("h_DilepEta_afterRecoee", "Dilepton eta after recoee", 1000, 0, 1000);
    h_DilepEta_afterRecoee->Sumw2();

    TH1D* h_DilepPhi_afterRecoee = new TH1D("h_DilepPhi_afterRecoee", "Dilepton phi after recoee", 1000, 0, 1000);
    h_DilepPhi_afterRecoee->Sumw2();
    ...
    TH1D* h_DilepPt_afterMET = new TH1D("h_DilepPt_afterMET", "Dilepton pT after MET", 1000, 0, 1000);
    h_DilepPt_afterMET->Sumw2();

    

    //TH1D* h_after_MET_scan_bkg = new TH1D("h_after_MET_scan_bkg", "After MET cut scanning", 1000, 0, 1000);
    //h_after_MET_scan_bkg->Sumw2();
    ...
    h_DilepMass_afterRecoee->Reset();
    h_DilepEta_afterRecoee->Reset();
    h_DilepPhi_afterRecoee->Reset();
    h_DilepPt_afterNvtx->Reset();
    h_DilepPt_afterTauVeto->Reset();
    h_DilepPt_afterElePairPt->Reset();
    h_DilepPt_afterZmass->Reset();
    h_DilepPt_afterExtraLepVeto->Reset();
    h_DilepPt_afterNthinjets->Reset();
    h_DilepPt_afterDilepPt->Reset();
    h_DilepPt_afterMET->Reset();
    //h_after_MET_scan_bkg->Reset();
    h_ee_npass->Reset();
        ...
        for (Long64_t jEntry = 0; jEntry < data.GetEntriesFast(); jEntry++)
        {
            ...
            //if (matchee)
            {
                ...
                if (recoeeEvent)
                {
                    ...
                    h_DilepPt_afterRecoee->Fill(DilepafterRecoee.Pt(), eventWeight);
                    h_DilepMass_afterRecoee->Fill(DilepafterRecoee.M(), eventWeight);
                    h_DilepEta_afterRecoee->Fill(DilepafterRecoee.Eta(), eventWeight);
                    h_DilepPhi_afterRecoee->Fill(DilepafterRecoee.Phi(), eventWeight);
                    ...
                    h_DilepPt_afterNvtx->Fill(DilepafterRecoee.Pt(), eventWeight);
                    ...
                    h_DilepPt_afterTauVeto->Fill(DilepafterRecoee.Pt(), eventWeight);
                    ...
                    h_DilepPt_afterElePairPt->Fill(DilepafterRecoee.Pt(), eventWeight);
                    ...
                    h_DilepPt_afterZmass->Fill(dilep.Pt(), eventWeight);
                    ...
                    h_DilepPt_afterExtraLepVeto->Fill(dilep.Pt(), eventWeight);
                    nZboson ++;
                    ...
                    h_DilepPt_afterNthinjets->Fill(Zboson.Pt(), eventWeight);
                    ...
                    h_DilepPt_afterDilepPt->Fill(Zboson.Pt(), eventWeight);
                    ...
                    h_DilepPt_afterMET->Fill(Zboson.Pt(), eventWeight);



                    //Applying ALPHA3D cut scanning//
                    //int cutvalue = 0;
                    //int discrepancy = 10;
                    //int bin = 0;
                    ...
                    /*while (cutvalue<=1000)
                    {
                        ...
                        //bin+=1;
                        if (met >= cutvalue)
                            h_after_MET_scan_bkg->Fill(cutvalue, eventWeight);
                        cutvalue+=1;
                    }*/
    ...
    h_DilepPt_afterRecoee->Write();
    h_DilepMass_afterRecoee->Write();
    h_DilepEta_afterRecoee->Write();
    h_DilepPhi_afterRecoee->Write();
    h_DilepPt_afterNvtx->Write();
    h_DilepPt_afterTauVeto->Write();
    h_DilepPt_afterElePairPt->Write();
    h_DilepPt_afterZmass->Write();
    h_DilepPt_afterExtraLepVeto->Write();
    h_DilepPt_afterNthinjets->Write();
    h_DilepPt_afterDilepPt->Write();
    h_DilepPt_afterMET->Write();
    //h_after_MET_scan_bkg->Write();
